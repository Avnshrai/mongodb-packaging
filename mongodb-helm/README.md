...
This chart bootstraps a [MongoDB(&reg;)](https://github.com/coredgeio/marketplace-apps/tree/beta) deployment on a [Kubernetes](https://kubernetes.io) cluster using the [Helm](https://helm.sh) package manager.
...
Refer to the [chart documentation for more information on each of these architectures](https://docs.coredge.com/kubernetes/infrastructure/mongodb/get-started/understand-architecture/).
...
| `image.repository`               | MongoDB(&reg;) image registry                                                                                                                               | `coredge/mongodb`      |
...
The [coredge MongoDB(&reg;) image](https://github.com/coredgeio/marketplace-apps/tree/beta) supports the use of custom scripts to initialize a fresh instance. In order to execute the scripts, two options are available:
...
Refer to the [chart documentation for more details and configuration examples](https://docs.coredge.com/kubernetes/infrastructure/mongodb/configuration/configure-external-access-replicaset/).
